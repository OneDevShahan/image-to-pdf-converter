    ...
    <div className='container my-5'>
        <div class="bg-dark text-secondary px-4 py-5 text-center">
            ...
            <div class="col-lg-6 mx-auto text-white">
                <p class="fs-5 mb-4">Transform single images into sleek PDFs seamlessly on our website.
                    Effortlessly convert your images to professional PDF documents in just a few clicks.</p>
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <input className="btn btn-outline-light btn-lg p-4 fw-bold" type="file" accept="image/*" onChange={handleFileChange} />
                    <button className= "btn btn-outline-success btn-lg px-4" disabled={!imageFile || loading} onClick={convertToPdf}>Convert to PDF</button>
                </div>
            </div>
        </div>    
    </div>
